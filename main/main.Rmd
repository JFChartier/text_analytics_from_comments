...
unique_word_preprocessed = sapply(unique_word_in_comments, function(x) paste("dummy", x, "dummy", sep = " ")) %>% text_preprocessing(text_in_claims = ., myFrenchStopwords = myFrenchStopwords, my_doc_count_min = 2, my_doc_proportion_max = .9, to_stemm = F, language = "fr", spelling_checker = F, charNgram = 4)
...
View(t(similarity_between_cat_word), title = "~")
#set_rownames(dat)
